...
<head>
    ...
    <title>Edit Wilayah - Admin</title>
...
<body>
    ...
    <main class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="fw-bold">Edit Wilayah</h1>
        ...
        <div class="card">
            <div class="card-header bg-white">
                <h5 class="fw-bold m-0"><i class="fas fa-edit me-2"></i>Form Edit Wilayah</h5>
            </div>
            <div class="card-body">
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox"
                                           ...
                                           {{ in_array($teknisi->id, old('teknisi_ids', $wilayah->teknisis->pluck('id')->toArray())) ? 'checked' : '' }}>
